 ...
 * @author Manyor
 */
public class frmModuloProveedores extends javax.swing.JFrame {

    /**
     * Creates new form frmChofer2
     */
    public frmModuloProveedores() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("MODULO DE PROVEEDORES");
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmModuloProveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmModuloProveedores().setVisible(true);
            }
        });
    }
